...
@Configuration
@EnableOAuth2Client
public class PingOneOpenIdConnectConfig {

    @Value("${ping.client-id}")
    private String clientId;

    @Value("${ping.client-secret}")
    private String clientSecret;

    @Value("${ping.access-token-uri}")
    private String accessTokenUri;

    @Value("${ping.user-authorization-uri}")
    private String userAuthorizationUri;

    @Value("${ping.redirect-uri}")
